    ...
    switch ($funcion) {
        case 'registro':
            ...
            if ($resultadoVerificacion->num_rows > 0) {
                ...
                // Inserción con contraseña hasheada
                $sql = "INSERT INTO paciente (correoElectronico, nombre, apellidos, contraseña) VALUES ('$email', '$nombre', '$apellidos', '$hashPassword')";
        ...
        case 'contacto':
            ...
            case 'pedirCita':
                ...
                if ($result_paciente->num_rows > 0) {
                    ...
                    $sql_paciente = "UPDATE paciente SET nombre='$nombre', apellidos='$apellidos', dni='$dni', provincia='$provincia', domicilio='$domicilio', codigo_postal='$postal', genero='$sexo' WHERE correoElectronico='$email'";
                } else {
                    // El paciente no existe, realizar un INSERT
                    $sql_paciente = "INSERT INTO paciente (correoElectronico, nombre, apellidos, dni, provincia, domicilio, codigo_postal, genero) VALUES ('$email', '$nombre', '$apellidos', '$password_hash', '$dni', '$provincia', '$domicilio', '$postal', '$sexo')";
                }
        ...
        case 'insertarPerfil':
            ...
            $sql = "UPDATE paciente SET nombre='$nombre', apellidos='$apellidos', contraseña='$hashContraseña', dni='$dni', provincia='$provincia', domicilio='$domicilio', genero='$genero' WHERE correoElectronico='$correoElectronico'";
